...
**File**: `_includes/session-descriptions`
...
- [ ] Create `_includes/session-descriptions` component
...
### To Create
- `_includes/session-descriptions` - Core display component for chronological descriptions

### To Modify
- `assets/css/style.css` - Add session-descriptions styling (append to end of file)
