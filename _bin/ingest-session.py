...
def build_draft(data: dict, case_id: str) -> str:
    played_at = data.get("playedAt", "YYYY-MM-DD")
    title_raw = data.get("title", f"Case {case_id}")
    ...
    lines += [
        ...
        "",
        "<!--",
        "  DRAFT — generated by _scripts/ingest_session.py",
        "  Before publishing:",
        ...
        "    3. Add wiki links: [Name](../dossiers/slug), [Place](../locales/slug)",
...
def main() -> None:
    ...
    draft_content = build_draft(data, case_id)
    ...
    print("  2. Fix proper nouns (see CLAUDE.md alias table)")
    print("  3. Add wiki links ([Name](../dossiers/slug))")
    print("  4. Fill in datestamp / when / session-number / title / description")
    print(f"  5. Rename to case-{case_id}.md when satisfied")
